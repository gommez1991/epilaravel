                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="treeview active">
                            ...
                            <ul class="treeview-menu">
                                <li class="active"><a href="./addstudent"><i class="fa fa-angle-double-right"></i> Ajouter Un Etudiant</a></li>
                                ...
                                <div class="box-body">
                                    <form action="" method="post">
                                        ...
                                        <div class="form-group col-xs-6">
                                            ...
                                            <input type="text" class="form-control" placeholder="Numero D'inscription" name="numero_inscrit" value=""  required>
                                        </div>
                                        <div class="form-group col-xs-6">
                                            <label>Pseudo</label>
