        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="treeview active">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li class="active"><a href="../listdepartment"><i class="fa fa-angle-double-right"></i>List Des departements</a></li>
            ...
            <aside class="right-side">                
                ...
                <section class="content-header">
                    <h1>
                        Modification de departement {{$departement->nom_departement}}
                        
                    </h1>
                    <ol class="breadcrumb">
                        <li><a href="#"><i class="fa fa-dashboard"></i> Accuille</a></li>
                        <li><a href="#">Gestion Ecole</a></li>
                        <li class="active"> Modifer département</li>
                    </ol>
                </section>
...
">
                                        {{$departement->nom_departement}}<br>
                                    </h1>
                                </div>
                                ...
                                <div class="box-body">
                                    <form action="" method="post">
                                        ...
                                        <div class="form-group col-xs-6">
                                            <label>Nom</label>
                                            <input type="text" class="form-control" name="nom_departement" value="{{$departement->nom_departement}}" >
                                        </div>
                                        <!-- textarea -->
                                        <div class="form-group col-xs-6">
                                            <label>Responsable de departement </label>
                                            <select class="form-control" name="responsable_id">
    <?php 
        $enseignant=DB::table('utilisateur')
            ->join('enseignant', 'utilisateur.id', '=', 'enseignant.user_id')
            ->select('enseignant.id','utilisateur.nom','utilisateur.prenom')
            ->get();
            
    ?>
     @foreach($enseignant as $key => $value)
        @if($value->id==$departement->responsable_id)
            <option selected value="{{$value->id}}" >{{$value->nom}} </option>
        @else
