   ...
   <head>
                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="treeview active">
                            ...
                            <ul class="treeview-menu">
                                <li class="active" ><a href="./adddepartment"><i class="fa fa-angle-double-right"></i>Ajouter Un departement</a></li>
    ...
    <?php 
        $enseignant=DB::table('utilisateur')
            ...
            ->select('enseignant.id','enseignant.user_id','utilisateur.nom','utilisateur.prenom')
            ->get();
    ...
    ?>
     ...
     @endforeach
                                    ...
                                    <div class="box-footer">
                                       ...
                                       <a class="btn btn-danger" href="./listdepartment"> Annuler</a>
                                    </div>
                                    </form>
                                </div><!-- /.box-body -->
                            </div>
