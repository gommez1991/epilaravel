                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="treeview active">
                            ...
                            <ul class="treeview-menu ">
                                ...
                                <li  class="active"><a href="./listmatiere"><i class="fa fa-angle-double-right"></i>List des matières</a></li>
                            </ul>
                        </li>
                        <li class="treeview">
                            <a href="#">
                ...
                <section class="content-header">
                    <h1>
                     ...
                     <ol class="breadcrumb">
                        ...
                        <li><a href="#">Gestion des matiéres</a></li>
                        <li class="active">Liste de matiére </li>
                    </ol>
                </section>
                                    ...
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        @foreach($matieres as $key => $value)
                                            <tr>
                                                ...
                                                <td><p>{{ $value->nom_matiere }}</p></td>
                                                <td>{{ $value->coefficient}}</td>
                                                <td>{{ $value->volume_horaire}}</td>
                                                <td>{{ $value->type}}</td>
                                                <td>{{ $value->nom_filiere}} {{ $value->nom_departement}}</td>
                                                <td>  <a  href="{{ URL::to('editmatiere/' . $value->id_matiere) }}"><button title="Modifier" type="button" class="btn btn-info btn-flat  fa fa-edit"></button></a> <a href="{{ URL::to('deletematiere/' . $value->id_matiere) }}"><button title="Supprimer" type="button" class="btn btn-danger btn-flat  fa fa-trash-o"></button></a> </td>
                                            </tr>
                                        @endforeach
                                        </tbody>
                                        <tfoot>
