        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="treeview active">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li class="active"><a href="./addfiliere"><i class="fa fa-angle-double-right"></i>Ajouter Un filiére</a></li>
            ...
            <aside class="right-side">                
                ...
                <section class="content-header">
                    <h1>
                        Modification de filière {{$filiere->nom_filiere}}
...
">
                                ...
                                <div class="box-body">
                                    <form action="" method="post">
                                        ...
                                        <div class="form-group col-xs-6">
                                            <label>Nom</label>
                                            <input type="text" class="form-control" name="nom_filiere" value="{{$filiere->nom_filiere}}" >
                                        </div>
                                        <!-- textarea -->
                                        <div class="form-group col-xs-6">
    ...
    ?>
     @foreach($departement as $key => $value)
        @if($value->id==$filiere->department_id)
            <option selected value="{{$value->id}}" >{{$value->nom_departement}} </option>
        @else
